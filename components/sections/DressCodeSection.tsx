    ...
    <section id="dresscode" style={{ padding: "6rem 1.5rem" }}>
      ...
      <div style={{ maxWidth: "600px", margin: "0 auto", textAlign: "center" }}>
        ...
        >
          ...
          <p style={{ fontFamily: "var(--font-cinzel), serif", fontSize: "10px", letterSpacing: "0.22em", color: "#9a7ab8", textTransform: "uppercase", marginBottom: "0.5rem" }}>
            Motif
          </p>
          <p style={{ fontFamily: "var(--font-cormorant), serif", fontStyle: "italic", fontSize: "36px", fontWeight: 300, lineHeight: 1.15 }}>
          ...
          <p style={{ fontFamily: "var(--font-im-fell), serif", fontStyle: "italic", fontSize: "13px", color: "#9a7ab8", marginTop: "0.5rem" }}>
        ...
        >
          <p style={{ fontFamily: "var(--font-cinzel), serif", fontSize: "10px", letterSpacing: "0.22em", color: "#9a7ab8", textTransform: "uppercase", marginBottom: "1.2rem" }}>
            Color Palette
          </p>
          ...
          <img
            ...
            alt="Color Palette"
            style={{ display: "block", width: "100%", maxWidth: "480px", height: "auto", opacity: 0.92, margin: "0 auto" }}
          />
        </motion.div>
        ...
        >
          Guests are encouraged to dress in the motif colors.<br />
